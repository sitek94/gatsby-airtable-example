  ...
  return (
    <Layout>
      <main
        ...
        `}
      >
        <div className="container mx-auto max-w-2xl p-6 bg-white rounded-md shadow-md">
          <div className="">
              ...
              <div className="flex mt-4">
                <div className="flex flex-col w-1/2">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="20">Silver - $20</option>
                ...
                <div className="ml-10 w-1/2">
                  ...
                  <p className="text-8xl">
                    ${calculateTotal(width, height, Number(type))}
                  </p>
                </div>
              </div>
            </form>
...
const calculateTotal = (width: number, height: number, type: number) => {
  return (((width * height) / 1000) * 0.75 * type).toFixed();
};
